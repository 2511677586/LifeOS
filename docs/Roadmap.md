...
Completed abilities:
- Ability-0001 Project Skeleton
- Ability-0002 Multiline Text Input
- Ability-0003 Save Button
- Ability-0004 Markdown Saving
- Ability-0005 Recent Records Browser
- Architecture Sprint-001 UI / Service / Storage separation
